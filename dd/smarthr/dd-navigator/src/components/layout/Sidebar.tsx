...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-16 w-64 h-[calc(100vh-4rem)] bg-white border-r border-gray-200/80 overflow-y-auto">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-100">
        <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-4">
          <p className="text-xs font-medium text-indigo-600 mb-1">今月の進捗</p>
